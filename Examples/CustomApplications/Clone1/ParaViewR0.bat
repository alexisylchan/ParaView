...
<COMPILEDPARAVIEW_DIRECTORY>\bin\paraview_revised.exe --tracker --tracker-address=<TRACKER_SERVER> --tracker-sensor=0 --tracker-origin="8.68,5.3,1.25" --spacenavigator --spacenavigator-address=<SPACENAVIGATOR_SERVER> --tng --tng-address=<TNG_SERVER> --phantom --phantom-address=<PHANTOM_SERVER> --stereo --stereo-type="Crystal Eyes"

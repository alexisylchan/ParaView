...
<COMPILEDPARAVIEW_DIRECTORY>\bin\paraview_revised.exe --vrpn --vrpn-address=<TRACKER_SERVER> --vrpn-sensor=1 --vrpn-origin="8.58,5.3,1.3" --stereo --stereo-type="Crystal Eyes"
...
C:\Users\alexisc\Documents\EVE\CompiledParaView\bin\Release\paraview_revised.exe --vrpn --vrpn-address=Tracker0@tracker1@cs.unc.edu --vrpn-sensor=1 --vrpn-origin="8.58,5.3,1.3" --stereo --stereo-type="Crystal Eyes"
:EndREADME
